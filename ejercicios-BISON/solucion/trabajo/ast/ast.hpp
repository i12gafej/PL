...
///////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////
// MODIFICADO EN LA ULTIMA PRACTICA
...
class ErrorStmt : public Statement {
    public:
        ErrorStmt(std::list<Statement *> *s) {}
		//ErrorStmt(std::list<Statement *> s, std::list<Statement *> ss) {}
        void printAST() {
            std::cout << "ErrorStmt" << std::endl;
        }
        void evaluate() {
            // No hacer nada, ya que es un error
