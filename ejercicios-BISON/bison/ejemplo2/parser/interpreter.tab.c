...
#line 1423 "interpreter.tab.c"
    break;

  case 9: /* exp: exp '-' exp  */
#line 102 "interpreter.y"
                { std::cout << "exp --> exp '-' exp" << std::endl;}
#line 1429 "interpreter.tab.c"
    break;

  case 10: /* exp: exp '*' exp  */
#line 105 "interpreter.y"
                { std::cout << "exp --> exp '*' exp" << std::endl;}
#line 1435 "interpreter.tab.c"
    break;

  case 11: /* exp: exp '/' exp  */
#line 108 "interpreter.y"
                { std::cout << "exp --> exp '/' exp" << std::endl;}
#line 1441 "interpreter.tab.c"
    break;

  case 12: /* exp: '(' exp ')'  */
#line 111 "interpreter.y"
                { std::cout << "exp --> '(' exp ')' " << std::endl;}
#line 1447 "interpreter.tab.c"
    break;
